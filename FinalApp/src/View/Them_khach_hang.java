 ...
 * @author trong
 */
public class Them_khach_hang extends javax.swing.JDialog {
private DefaultTableModel tableModel;
    private QuanLy_UI quanli_ui;
    public int maKH_sql;

    public Them_khach_hang(JFrame parent, DefaultTableModel tableModel) {
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        KhachHang KH = new KhachHang(tenkh, sdt, loai);       
        maKH_sql = KhachHangDAO.ThemKH(KH);
     ...
     private void addKH(KhachHang KH) {
        Object[] rowData = {maKH_sql, KH.getTenKH(), KH.getSDT(), KH.getLoaiKH()};
